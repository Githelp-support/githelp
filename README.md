...
[Githelp](https://githelp.app/) is a free-to-use (for open-source) support infrastructure platform that solves 3 major problems. Providing the possibility to easily provide paid support to users, the possibility to seemlessly engage the community in support efforts and providing businesses greater trust in your products through Support-Level agreements and the accessibility of support.
